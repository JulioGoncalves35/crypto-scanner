...
- **OBV age como filtro implícito de SHORTs fracos:** OBV em ascensão adiciona +6 ao score independente de direção. Em setups SHORT (score < 0), esse +6 reduz a magnitude do score — SHORTs com OBV contraditório perdem força e podem não passar o threshold. **Não tornar isso neutro** — testes mostraram que neutralizar o OBV para SHORTs permite que trades de baixa qualidade passem o filtro (31 trades extras com 39% WR), piorando drasticamente os resultados.
